...
// Spinner component with smooth appearance animation
var Spinner = function () { return (<svg className='h-4 w-4 animate-spin' xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24'>
        <circle className='opacity-25' cx='12' cy='12' r='10' stroke='currentColor' strokeWidth='4'></circle>
        <path className='opacity-75' fill='currentColor' d='M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z'></path>
    </svg>); };
var buttonVariants = (0, class_variance_authority_1.cva)('items-center justify-center rounded-sm font-medium transition-all duration-300 ease-out disabled:opacity-50 hover:cursor-pointer disabled:cursor-not-allowed leading-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 select-none hover:shadow-[0_1px_3px_0_rgb(0,0,0,0.1),0_1px_2px_-1px_rgb(0,0,0,0.1)]', {
    variants: {
        color: {
            primary: '',
            neutral: '',
...
var Button = React.forwardRef(function (_a, ref) {
    var color = _a.color, variant = _a.variant, size = _a.size, _b = _a.asChild, asChild = _b === void 0 ? false : _b, leadingIcon = _a.leadingIcon, trailingIcon = _a.trailingIcon, _c = _a.iconOnly, iconOnly = _c === void 0 ? false : _c, _d = _a.isLoading, isLoading = _d === void 0 ? false : _d, loadingText = _a.loadingText, className = _a.className, children = _a.children, disabled = _a.disabled, _e = _a.fullWidth, fullWidth = _e === void 0 ? false : _e, props = __rest(_a, ["color", "variant", "size", "asChild", "leadingIcon", "trailingIcon", "iconOnly", "isLoading", "loadingText", "className", "children", "disabled", "fullWidth"]);
    var Comp = asChild ? react_slot_1.Slot : 'button';
    // If iconOnly is true, we only render the leadingIcon
    var icon = iconOnly ? leadingIcon : null;
    // Determine if button should be disabled (when loading or explicitly disabled)
    var isDisabled = isLoading || disabled;
    return (<Comp ref={ref} type='button' className={buttonVariants({
            color: color,
            variant: variant,
            size: size,
            isIcon: iconOnly,
...
Button.displayName = 'Button';
// export default Button;
var ButtonMemoized = (0, react_1.memo)(Button);
exports.Button = ButtonMemoized;
