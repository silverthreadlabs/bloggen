...
export const Tabs = ({
	...
	// Add type guard to ensure propTabs has at least one element
	...
	const moveSelectedTabToTop = (idx: number) => {
		...
		const firstTab = selectedTab[0];
		
		// Type guard to ensure firstTab exists
		if (firstTab) {
...
export const FadeInDiv = ({
	...
	const isActive = (tab: Tab) => {
		// Type guard to ensure tabs[0] exists
