...
import { Component as ChangePlanComponent } from '@/components/settings/components/change-plan';
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    {currentSession?.user.emailVerified && (
                                        <Badge className="bg-success-bg text-success-text border-success-border" variant="outline">
                                            <svg
