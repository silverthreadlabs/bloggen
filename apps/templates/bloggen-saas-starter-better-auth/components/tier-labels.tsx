...
const tierVariants = cva(
	"inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ring-1 ring-inset transition-all duration-300 ease-in-out",
	{
		variants: {
			variant: {
				free: "bg-gray-500 text-white ring-gray-400 ",
				starter: "bg-lime-700/40 text-white ring-lime-200/40 ",
				professional: "bg-purple-800/80 ring-purple-400",
				enterprise: "bg-amber-500 text-black ring-amber-400",
			},
		},
		defaultVariants: {
			variant: "free",
